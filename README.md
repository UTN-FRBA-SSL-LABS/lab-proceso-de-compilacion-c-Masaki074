...
> **R: Tiene todas las macros expandidas**
...
> **R:El preprocesador eliminala los cometnarios por lo que "Archivo fuente principal" es removido**
...
> **R:**
216:# 100 "C:/msys64/ucrt64/include/stdio.h" 2 3
234:  __attribute__((__format__(__gnu_scanf__, 1,0))) __attribute__ ((__nonnull__ (1)))
254:  __attribute__((__format__(__gnu_printf__,1,0))) __attribute__ ((__nonnull__ (1)))
288:  __attribute__((__format__(__ms_scanf__, 1,0))) __attribute__ ((__nonnull__ (1)))
305:  __attribute__((__format__(__ms_printf__, 1,0))) __attribute__ ((__nonnull__ (1)))
504:  __attribute__((__format__(__ms_printf__, 1,0))) __attribute__ ((__nonnull__ (1)))
699:# 1206 "C:/msys64/ucrt64/include/stdio.h" 3
2148:# 190 "C:/msys64/ucrt64/include/malloc.h" 3
...
> **R:** El N representa el numero de linea en el archivo que se esta usando 
         El printf proviene del archivo C:/msys64/ucrt64/include/stdio.h
...
> **R:** Se esta creando un entorno de trabajo para la funcion sumar, usando pilas y punteros 
...
> **R:** En matematica.o esta la definición de la funcion mientras que en programa.o se llama la función.
...
> **R:** Queda ya que representa el final de una sección lo resuelve el loader en fase de carga en memoria
...
> **R:** Una macro función es solamente un código que se reemplaza en la fase de precompilado y no tiene verificación de tipos, la función "desaparece" en el .exe y es la que tiene verificación 
...
> **R:** El T son funciones y el D son variables globales con valor inicial, T vive en la sección text y D en la de DATA
